...
namespace TheWorld.MVC.Controllers.Web
{
    #region
    ...
    using TheWorld.MVC.Controllers.Web.Interfaces;
    ...
    public class AppController : Controller, IAppController
    {
        ...
        /// </summary>
        private readonly IEntityRepository<Entity> localRepository;
        ...
        /// The logger.
        /// </param>
        public AppController(IMailService mailService, IConfigurationRoot config, IEntityRepository<Entity> repository, ILogger<AppController> logger)
        {
        ...
        public IActionResult Index()
        {
            try
            {
                var data = this.localRepository.GetAll();
